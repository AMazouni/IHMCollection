package testInterfaceLinkedList;

import java.util.*;

public class TestInterfaceLinkedList {
	public static void main(String args[]) {
		System.out.println("TestInterfaceLinkedList\n");
		...
		it.add("Essaouira");
		it.add("Casa"); // et on ajoute deux elements
		System.out.print("Liste en C : ");
		afficher(liste);
		it = liste.listIterator();
		it.next(); // on progresse d'un element
		it.add("Casa");
		it.add("Marrakech"); // et on ajoute deux elements
